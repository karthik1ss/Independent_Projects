...
import org.apache.hadoop.util.*;
	...
	public class HW1_3 
	{
			    ...
			    public static class WordCountMap extends MapReduceBase implements Mapper<LongWritable, Text, Text, IntWritable> 
			    {
				      ...
				      public void map(LongWritable key, Text value, OutputCollector<Text, IntWritable> output, Reporter reporter) throws IOException 
				      {
				        ...
				        visiteelastname = split[19];
				       	...
				       	if(split.length>= 20)
				       	{
				       		if((! firstname .isEmpty() && !lastname.isEmpty()) || (! visiteefirstname.isEmpty() && !visiteelastname.isEmpty()) )
				       		{
				       			visitor = firstname + lastname;
				       		    visitee = visiteelastname + visiteefirstname;
				       		    word.set(visitor + visitee);
	    ...
	    public static void main(String[] args) throws Exception 
	    {
	         ...
	         JobConf conf = new JobConf(HW1_3.class);          // Create a JobConf object
	         ...
	         conf.setMapperClass(HW1_3.WordCountMap.class);					// specifies the mapper class
	 	     conf.setCombinerClass(HW1_3.WordCountReduce.class); 			// specifies the combiner
	 	     conf.setReducerClass(HW1_3.WordCountReduce.class); 			// specifies the reducer
	        ...
	        job.setMapperClass(HW1_3.Top10Map.class);					// specifies the mapper class
	        job.setCombinerClass(HW1_3.Top10Reduce.class); 			// specifies the combiner
	        job.setReducerClass(HW1_3.Top10Reduce.class); 			// specifies the reducer
